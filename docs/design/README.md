...
8. [模型协议与配置体系](05-模型协议与配置体系.md)
9. [编排、持久化与交付通道](06-编排持久化与交付通道.md)
10. [持久化存储设计与 Phoenix 借鉴](11-持久化存储设计与Phoenix借鉴.md)
11. [安全、审计、可观测性与评测](07-安全审计可观测性与评测.md)
12. [实施路线图与学习实验](08-实施路线图与学习实验.md)
13. [完整配置示例](09-完整配置示例.md)
14. [v2 可执行实现规格](13-v2可执行实现规格.md)
15. [v2 评审修复实施规格](14-v2评审修复实施规格.md)
